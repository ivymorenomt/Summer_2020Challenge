#different list comprehension practice problems
...
def vowels(word):
    ...
    Given a string representing a word, write a list comprehension that produces a list of all the vowels in that word.
        ...
        ['a', 'e', 'a', 'i']
    """
    return [str(char) for char in word if char in 'aeiou']
...
def disemvowel(sentence):
    ...
    """
    return ''.join(char for char in sentence if char not in 'aieou')
